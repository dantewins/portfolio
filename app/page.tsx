...
const projects = [
  ...
  },
  {
    ...
    icon: <HurricaneIcon size={32} weight="duotone" className="text-zinc-900" />,
  },
  {
    title: "Bunni",
    ...
    icon: <RabbitIcon size={32} weight="duotone" className="text-zinc-900" />,
  },
  {
    title: "Expounder",
    ...
    icon: <NoteIcon size={32} weight="duotone" className="text-zinc-900" />,
  },
];
